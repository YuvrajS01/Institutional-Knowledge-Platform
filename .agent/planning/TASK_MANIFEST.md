...
| P5-012 | P1 | DONE | Add search analytics | P5-009 |
| P5-013 | P1 | DONE | Add unresolved-search workflow | P5-012 |
...
| P7-004 | P1 | DONE | Implement email adapter | P7-002 |
| P7-005 | P1 | DONE | Add relevance rules | P7-002,P1-005 |
| P7-006 | P1 | DONE | Add deadline reminder jobs | P7-005,P3-007 |
...
| P8-003 | P1 | DONE | Create cloud LLM adapter | P8-001 |
