...
| P3-008 | P0 | TODO | Implement chunking | P3-004 |
| P3-009 | P1 | TODO | Add processing retry/status UI | P3-004,P2-008 |
| P3-010 | P1 | TODO | Add scanned-PDF integration tests | P3-003,P3-004 |
...
| P4-006 | P0 | TODO | Add publication permission tests | P4-002,P1-007 |
...
| P5-009 | P0 | TODO | Implement search API | P5-007 |
| P5-010 | P0 | TODO | Build search results UI | P5-009 |
...
| P5-014 | P0 | TODO | Build search evaluation set | P5-007 |

## Phase 6 — Consumption

| ID | Pri | Status | Task | Depends On |
|---|---|---|---|---|
| P6-001 | P0 | TODO | Build document detail API | P2-004,P4-003 |
...
| ID | Pri | Status | Task | Depends On |
|---|---|---|---|---|
| P8-001 | P0 | TODO | Create LLM provider interface | P0-007 |
...
| P8-006 | P0 | TODO | Implement RAG answer service | P8-002,P8-005 |
| P8-007 | P0 | TODO | Implement citation contract | P8-006 |
| P8-008 | P0 | TODO | Implement unsupported-answer behavior | P8-006 |
...
| ID | Pri | Status | Task | Depends On |
|---|---|---|---|---|
| P9-001 | P0 | TODO | Full E2E critical-path suite | P6-002,P8-010 |
| P9-002 | P0 | TODO | Full security regression suite | P1-007,P4-006,P8-013 |
...
| P9-008 | P0 | TODO | Run MVP final gate | ALL_P0 |
